/**
 * this is the main view of our helpdesk demo app integration details for the
 * communication with the gamification service can be found in the openTickets
 * controller
 */
sap.ui.jsview("helpdesk.openTickets", {
    ...
    createContent: function (controller) {
        ...
        return new sap.ui.commons.layout.HorizontalLayout("ticketsWorkbench", {
